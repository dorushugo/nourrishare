...
import 'ingredients_voisins_model.dart';
export 'ingredients_voisins_model.dart';

class IngredientsVoisinsWidget extends StatefulWidget {
  const IngredientsVoisinsWidget({
    Key? key,
    required this.plat,
  }) : super(key: key);
  ...
  @override
  _IngredientsVoisinsWidgetState createState() =>
      _IngredientsVoisinsWidgetState();
}

class _IngredientsVoisinsWidgetState extends State<IngredientsVoisinsWidget> {
  late IngredientsVoisinsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => IngredientsVoisinsModel());
