...
import 'recherche_users_model.dart';
export 'recherche_users_model.dart';

class RechercheUsersWidget extends StatefulWidget {
  const RechercheUsersWidget({Key? key}) : super(key: key);

  @override
  _RechercheUsersWidgetState createState() => _RechercheUsersWidgetState();
}

class _RechercheUsersWidgetState extends State<RechercheUsersWidget> {
  late RechercheUsersModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => RechercheUsersModel());
