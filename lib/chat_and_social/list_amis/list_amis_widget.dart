...
import 'list_amis_model.dart';
export 'list_amis_model.dart';

class ListAmisWidget extends StatefulWidget {
  const ListAmisWidget({Key? key}) : super(key: key);

  @override
  _ListAmisWidgetState createState() => _ListAmisWidgetState();
}

class _ListAmisWidgetState extends State<ListAmisWidget> {
  late ListAmisModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ListAmisModel());
                            ...
                            child: Padding(
                              ...
                              child: PagedListView<DocumentSnapshot<Object?>?,
                                ...
                                pagingController: _model.setListViewController1(
                                  FriendRequestRecord.collection.where(
                                    'to',
                                ...
                                builderDelegate: PagedChildBuilderDelegate<
                                  ...
                                  itemBuilder: (context, _, listViewIndex) {
                                    final listViewFriendRequestRecord = _model
                                    ...
                                    return Padding(
                                      ...
                                      child: StreamBuilder<UsersRecord>(
                                        stream: UsersRecord.getDocument(
                                            listViewFriendRequestRecord.from!),
                              ...
                              child: StreamBuilder<List<GroupesRecord>>(
                                ...
                                builder: (context, snapshot) {
                                  ...
                                  return ListView.separated(
                                    ...
                                    itemCount: listViewGroupesRecordList.length,
                          ...
                          Builder(
                            builder: (context) => Padding(
                              ...
                              child: FFButtonWidget(
                                onPressed: () async {
                                  await Share.share(
                                    'Je t\'invite à installer NourriShare, l\'application qui permet de vendre ses plats entres collègues et voisins ! https://nourrishare.com',
                                    sharePositionOrigin:
