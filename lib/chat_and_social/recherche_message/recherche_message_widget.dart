...
class RechercheMessageWidget extends StatefulWidget {
  const RechercheMessageWidget({Key? key}) : super(key: key);

  @override
  _RechercheMessageWidgetState createState() => _RechercheMessageWidgetState();
}
                              ...
                              onTap: () async {
                                ...
                                await GroupesRecord.search(
                                  ...
                                  searchRadiusMeters: 10000.0,
                                    ...
                                    .then(
                                        (r) => _model.algoliaSearchResults2 = r)
                                    .onError((_, __) =>
                                                                    ...
                                                                    child: Text(
                                                                      valueOrDefault<
                                                                        ...
                                                                        functions.calculateDistance(
                                                                            ...
                                                                            listViewUsersRecord
                                                                                .longitude,
                                                                            valueOrDefault(currentUserDocument?.latitude,
                                                                                0.0),
                                                                            valueOrDefault(currentUserDocument?.longitude, 0.0)),
                                                                        'Inconnue',
                                                                      ),
                                                                      style: FlutterFlowTheme.of(
                                                                              context)
                          ...
                          Builder(
                            builder: (context) => Padding(
                              ...
                              child: FFButtonWidget(
                                ...
                                text: 'Inviter un ami sur NourriShare',
                                options: FFButtonOptions(
                                  width: double.infinity,
                                  height: 60.0,
                                  padding: EdgeInsetsDirectional.fromSTEB(
